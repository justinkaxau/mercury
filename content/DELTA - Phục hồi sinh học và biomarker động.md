...
Nghiên cứu DELTA (NCT06630637) là một thử nghiệm can thiệp tiến cứu, mở (open-label) trên một cá nhân ($N=1$, đối tượng DELTA001 / tác giả [[Dean Ho và thử nghiệm trường thọ|Dean Ho]], 45 tuổi), công bố trên tạp chí *PLOS ONE* vào tháng 8-2026. Trọng tâm của nghiên cứu là đánh giá và định lượng **khả năng phục hồi sinh học** (biological resilience) thông qua việc theo dõi quỹ đạo động học của các dấu ấn sinh học (biomarkers) trước và sau các tác nhân gây stress sinh lý chuẩn hóa (nhịn ăn, tập luyện), kết hợp với can thiệp lối sống tổ hợp và nền tảng y tế số.
...
```
Stressor hệ thống (Nhịn ăn 48h / Vận động nặng)
   ↓
Kích hoạt phản ứng chuyển hóa & sinh hóa (Gốc stress)
   ↓
Theo dõi quỹ đạo biến đổi (Biomarker Dynamics) & Tốc độ hồi phục (Recovery Kinetics)
   ↓
Định lượng năng lực phục hồi sinh học (Biological Resilience Indicator)
```
...
|---|---|---|
| **Nhịn ăn gián đoạn (TRE)** | Khung ăn 4 giờ (11:00 - 15:00), nhịn ăn tối thiểu 20 giờ mỗi ngày; định kỳ thực hiện các đợt nhịn nước hoàn toàn 48 giờ (chỉ uống nước, không calo, không thực phẩm bổ sung). | Hoàn tất tiêu hóa trước khi ngủ; kích hoạt chuyển đổi chuyển hóa sang thể ketone; tạo stressor chuẩn hóa. |
...
1. **Giai đoạn 1 (Khởi phát đường phân - Glycolytic Onset):** Ngay khi bắt đầu nâng tạ, lượng glucose trong máu tăng vọt và mức ketone giảm nhanh chóng. Hiện tượng này phản ánh sự chuyển đổi cơ chất khẩn cấp sang tân tạo đường/đường phân để cung cấp năng lượng tức thời cho cơ bắp.
2. **Giai đoạn 2 & 3 (Hồi phục ketosis - Ketotic Recovery):** Sau khi ngừng tập, nồng độ ketone bật tăng trở lại theo quỹ đạo hàm đa thức bậc hai (second-order polynomial pattern), tăng liên tục trong khoảng 100 phút trước khi đạt trạng thái bình nguyên.
...
Trong chế độ ăn một bữa mỗi ngày (OMAD), thời gian cần thiết để cơ thể chuyển từ trạng thái sau ăn sang ketosis (nồng độ ketone trong máu $\ge 0{,}5\ \text{mmol/L}$) rút ngắn từ hơn 20 giờ xuống còn 16,5 giờ sau chuỗi ngày thích nghi, cho thấy sự gia tăng hiệu quả chuyển đổi chuyển hóa (metabolic switching).

---

## 4. Quỹ đạo các Biomarker Tim mạch và Đa hiệu

Nghiên cứu khảo sát các chỉ số máu tại 3 trạng thái: trước nhịn 48h (PRE48), sau nhịn 48h (POST48) và sau khi ăn lại 2–3 ngày (POST-RF), đối chiếu với chế độ ăn 3 bữa thông thường (3MAD).

```
PRE48 (Mức nền tối ưu) ──(Nhịn 48h)──> POST48 (Biến động sinh lý) ──(Ăn lại 2-3 ngày)──> POST-RF (Hồi phục mức nền)
```
...
- Sau 48 giờ nhịn ăn, nồng độ hs-CRP không hề tăng (PRE48: $0{,}41\ \text{mg/L} \rightarrow$ POST48: $0{,}28\ \text{mg/L}$), cho thấy cơ thể không bị kích hoạt đáp ứng viêm tiêu cực trước stress chuyển hóa cấp.
...
- **Định lượng diện tích dưới đường cong (AUC) và Chỉ số phục hồi (RI):**
  ...
  - Giá trị RI tăng liên tục qua 3 chu kỳ: $22{,}1 \rightarrow 28{,}5 \rightarrow 32{,}1\ \mu\text{mol}\cdot\text{day/L}$, phản ánh đáp ứng giảm chấn trước stressor và sự hình thành khả năng phục hồi methyl hóa bền vững.
...
So sánh giữa dữ liệu hồi cứu (RETRO - Q1/2024, đi ngủ lúc 00:00) và dữ liệu can thiệp (START & END, đi ngủ lúc 21:15) ghi nhận qua thiết bị đeo:
...
| **Giấc ngủ sâu (Deep / SWS)** | $28{,}9 \pm 1{,}8$ phút | $43{,}0 \pm 2{,}5$ phút | $43{,}3 \pm 2{,}9$ phút | Tăng gần 50% thời lượng sóng chậm |
| **Giấc ngủ REM** | $65{,}2 \pm 2{,}7$ phút | $90{,}6 \pm 4{,}5$ phút | $108{,}0 \pm 4{,}8$ phút | Tăng 65%, củng cố trí nhớ và nhận thức |
| **Giấc ngủ nông (Light)** | $286{,}7 \pm 8{,}3$ phút | $324{,}4 \pm 6{,}4$ phút | $341{,}6 \pm 5{,}7$ phút | Tăng tỷ lệ thuận theo tổng thời gian |
| **Thời gian thức trong đêm** | $26{,}6 \pm 3{,}5$ phút | $19{,}2 \pm 3{,}7$ phút | $13{,}2 \pm 1{,}4$ phút | Giảm 50%, giấc ngủ liền mạch hơn |

Cơ chế cải thiện bắt nguồn từ việc phối hợp ngủ sớm (tăng tiết melatonin sớm, tăng hoạt tính phó giao cảm ban đêm), tập thể dục sáng (tăng cường trương lực đối giao cảm buổi tối) và kết thúc ăn trước 15:00 (tránh gánh nặng tiêu hóa ảnh hưởng đến chu kỳ sinh học).
...
- Gián đoạn giấc ngủ và sụt giảm HRV chỉ xuất hiện ở các chuyến bay đêm ngắn (dưới 4 giờ) do thiếu hụt cơ hội ngủ, chứ không phải do việc thay đổi múi giờ gây ra.
...
3. **Kích hoạt con đường cứu vãn chuyển hóa (Metabolic Salvage Pathways):** Phân tích PICRUSt2 dự đoán sự điều hòa tăng có ý nghĩa thống kê ($p \le 0{,}05$) của 2 con đường:
   - **PWY-5532:** Con đường cứu vãn của vi khuẩn cổ (Archaea) nhằm tái chế nucleoside và bazơ nitơ thành đường phosphat, tạo ra 3-phospho-D-glycerat (G3P) để cấp nguyên liệu cho chu trình đường phân khi nguồn carbohydrate từ thức ăn bị cắt đứt.
...
Phỏng vấn định tính bán cấu trúc qua 3 mốc thời gian cho thấy việc người tham gia trực tiếp nhìn thấy dữ liệu thời gian thực (từ que thử và thiết bị đeo) hoạt động như một cơ chế **trò chơi hóa** (gamification). Dữ liệu đóng vai trò là một "can thiệp hành vi" độc lập:
...
- Mục tiêu "đóng vòng hoạt động" và đạt điểm giấc ngủ $\ge 80$ củng cố tính tự giác duy trì kỷ luật dài hạn.

### Trợ lý Healthspan Copilot & Ước tính tuổi sinh học

Hệ thống GPT tùy chỉnh được tích hợp mô hình hồi quy bình phương tối thiểu (OLS) xây dựng từ tập dữ liệu dân số NHANES (gồm 10 biến số lâm sàng: HbA1c 4,6%, cân nặng 74 kg, vòng eo 73,7 cm, hs-CRP 0,28 mg/L, HDL 65 mg/dL, huyết áp 109/63 mmHg, nhịp tim 57 bpm, giới tính, tuổi thực tế):
...
- Nghiên cứu nhấn mạnh đây là mô hình tạo giả thuyết và công cụ hỗ trợ tuân thủ hành vi, không phải thước đo trẻ hóa chẩn đoán y khoa độc lập.
...
2. **Đối tượng đồng thời là nghiên cứu viên chính:** Dữ liệu hiển thị liên tục và hành vi bị tác động bởi nhận thức đang tham gia nghiên cứu (hiệu ứng Hawthorne), không có nhóm đối chứng mù.
...
6. **Ngưỡng dấu ấn chưa chuẩn hóa:** Các phân loại "elite", "optimal" và chỉ số phục hồi (RI) là khái niệm thăm dò, chưa phải chuẩn lâm sàng quốc tế.
7. **Hệ vi sinh thiếu dữ liệu nền dài hạn:** Ba tuần ăn 3 bữa không đại diện chắc chắn cho một chế độ không nhịn ăn bền vững; các con đường chuyển hóa là dự đoán từ PICRUSt2 chứ không đo trực tiếp hoạt tính sinh hóa.
...
9. **Rủi ro theo dõi xâm lấn dày đặc:** Lấy máu quá thường xuyên có nguy cơ chẩn đoán quá mức và thiếu máu. Nghiên cứu tuân thủ giới hạn an toàn: tối đa $10{,}5\ \text{mL/kg}$ hoặc $550\ \text{mL}$ trong mỗi chu kỳ 8 tuần.
10. **Xung đột lợi ích tiềm năng:** Một số tác giả là đồng sáng chế các bằng sáng chế về dấu ấn phục hồi số, nền tảng tối ưu sức khỏe và AI Copilot; đồng thời giữ vai trò cố vấn/sáng lập tại một số doanh nghiệp y tế số (KYAN, AMILI, Elyx...).
...
- **Kết quả thực nghiệm vững chắc nhất là gì?** Khả năng đo lường lặp lại chu kỳ đáp ứng - phục hồi của glucose, ketone và homocysteine trước stressor chuẩn hóa; cùng xu hướng cải thiện cấu trúc giấc ngủ kéo dài 7 tháng.
...
- [[Dean Ho và thử nghiệm trường thọ]]: Ghi chép hành trình thực nghiệm cá nhân và góc nhìn truyền thông đại chúng của tác giả Dean Ho.
